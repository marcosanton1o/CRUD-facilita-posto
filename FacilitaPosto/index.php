...
<nav class="navbar navbar-expand-lg fixed-top">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
      <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Página Principal</h5>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body align-items-center">
        <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
          <li class="nav-item px-3 py-2">
            <a class="h4 " aria-current="page" href="#">Página Inicial</a>
          </li>
          <li class="nav-item px-3 py-2">
            <a class="h4 " aria-current="page" href="#">Posto</a>
          </li>
          <li class="nav-item px-3 py-2">
            <a class="h4 " aria-current="page" href="#">Posto</a>
          </li>
...
<!--<nav class="navbar navbar-light navbar-expand-lg bg-light fixed-top">
  ...
  <div class="navbar-brand" href="#">
      <img src="imagens/perfil.png" alt="Avatar Logo" style="width:40px;" class="rounded-pill"> 
    </div>
  </div>-->